...
public typealias HeadersInit = JSValue
public typealias XMLHttpRequestBodyInit = JSValue
public typealias BodyInit = JSValue
public typealias RequestInfo = JSValue
public typealias DOMHighResTimeStamp = Double
public typealias EpochTimeStamp = UInt64
public typealias FormDataEntryValue = JSValue
public typealias ReadableStreamReader = JSValue
public typealias ReadableStreamController = JSValue
public typealias HTMLOrSVGScriptElement = JSValue
public typealias MediaProvider = JSValue
public typealias RenderingContext = JSValue
public typealias HTMLOrSVGImageElement = JSValue
public typealias CanvasImageSource = JSValue
public typealias CanvasFilterInput = [String: JSValue]
public typealias OffscreenRenderingContext = JSValue
...
public typealias TimerHandler = JSValue
public typealias ImageBitmapSource = JSValue
public typealias MessageEventSource = JSValue
public typealias BufferSource = JSValue
public typealias DOMTimeStamp = UInt64
public typealias BlobPart = JSValue
