...
public class MediaTrackCapabilities: BridgedDictionary {
    public convenience init(width: ULongRange, height: ULongRange, aspectRatio: DoubleRange, frameRate: DoubleRange, facingMode: [String], resizeMode: [String], sampleRate: ULongRange, sampleSize: ULongRange, echoCancellation: [Bool], autoGainControl: [Bool], noiseSuppression: [Bool], latency: DoubleRange, channelCount: ULongRange, deviceId: String, groupId: String, whiteBalanceMode: [String], exposureMode: [String], focusMode: [String], exposureCompensation: MediaSettingsRange, exposureTime: MediaSettingsRange, colorTemperature: MediaSettingsRange, iso: MediaSettingsRange, brightness: MediaSettingsRange, contrast: MediaSettingsRange, saturation: MediaSettingsRange, sharpness: MediaSettingsRange, focusDistance: MediaSettingsRange, pan: MediaSettingsRange, tilt: MediaSettingsRange, zoom: MediaSettingsRange, torch: Bool, displaySurface: String, logicalSurface: Bool, cursor: [String]) {
