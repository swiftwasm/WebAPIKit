...
public extension CanvasFillStrokeStyles {
    var strokeStyle: __UNSUPPORTED_UNION__ {
        get { ReadWriteAttribute["strokeStyle", in: jsObject] }
        set { ReadWriteAttribute["strokeStyle", in: jsObject] = newValue }
    }

    var fillStyle: __UNSUPPORTED_UNION__ {
        get { ReadWriteAttribute["fillStyle", in: jsObject] }
        set { ReadWriteAttribute["fillStyle", in: jsObject] = newValue }
    }

    func createLinearGradient(x0: Double, y0: Double, x1: Double, y1: Double) -> CanvasGradient {
        jsObject["createLinearGradient"]!(x0.jsValue(), y0.jsValue(), x1.jsValue(), y1.jsValue()).fromJSValue()!
    }
    ...
    func createRadialGradient(x0: Double, y0: Double, r0: Double, x1: Double, y1: Double, r1: Double) -> CanvasGradient {
        ...
        return jsObject["createRadialGradient"]!(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5).fromJSValue()!
    }

    func createConicGradient(startAngle: Double, x: Double, y: Double) -> CanvasGradient {
        jsObject["createConicGradient"]!(startAngle.jsValue(), x.jsValue(), y.jsValue()).fromJSValue()!
    }

    func createPattern(image: CanvasImageSource, repetition: String) -> CanvasPattern? {
        jsObject["createPattern"]!(image.jsValue(), repetition.jsValue()).fromJSValue()!
    }
}
