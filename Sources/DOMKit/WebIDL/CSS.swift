...
public enum CSS {
    ...
    @inlinable public static var animationWorklet: Worklet { ReadonlyAttribute[Strings.animationWorklet, in: jsObject] }

    @inlinable public static func supports(property: String, value: String) -> Bool {
    ...
    @inlinable public static func supports(conditionText: String) -> Bool {
        let this = JSObject.global[Strings.CSS].object!
        return this[Strings.supports].function!(this: this, arguments: [conditionText.jsValue()]).fromJSValue()!
    }

    @inlinable public static var highlights: HighlightRegistry { ReadonlyAttribute[Strings.highlights, in: jsObject] }

    @inlinable public static var elementSources: JSValue { ReadonlyAttribute[Strings.elementSources, in: jsObject] }

    @inlinable public static var layoutWorklet: Worklet { ReadonlyAttribute[Strings.layoutWorklet, in: jsObject] }

    @inlinable public static var paintWorklet: Worklet { ReadonlyAttribute[Strings.paintWorklet, in: jsObject] }

    @inlinable public static func parseStylesheet(css: CSSStringSource, options: CSSParserOptions? = nil) -> JSPromise {
        let this = JSObject.global[Strings.CSS].object!
    ...
    @inlinable public static func parseStylesheet(css: CSSStringSource, options: CSSParserOptions? = nil) async throws -> [CSSParserRule] {
        let this = JSObject.global[Strings.CSS].object!
    ...
    @inlinable public static func parseRuleList(css: CSSStringSource, options: CSSParserOptions? = nil) -> JSPromise {
        let this = JSObject.global[Strings.CSS].object!
        return this[Strings.parseRuleList].function!(this: this, arguments: [css.jsValue(), options?.jsValue() ?? .undefined]).fromJSValue()!
    }

    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    @inlinable public static func parseRuleList(css: CSSStringSource, options: CSSParserOptions? = nil) async throws -> [CSSParserRule] {
        let this = JSObject.global[Strings.CSS].object!
    ...
    @inlinable public static func parseRule(css: CSSStringSource, options: CSSParserOptions? = nil) -> JSPromise {
        let this = JSObject.global[Strings.CSS].object!
        return this[Strings.parseRule].function!(this: this, arguments: [css.jsValue(), options?.jsValue() ?? .undefined]).fromJSValue()!
    }

    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    @inlinable public static func parseRule(css: CSSStringSource, options: CSSParserOptions? = nil) async throws -> CSSParserRule {
        let this = JSObject.global[Strings.CSS].object!
    ...
    @inlinable public static func parseDeclarationList(css: CSSStringSource, options: CSSParserOptions? = nil) -> JSPromise {
        let this = JSObject.global[Strings.CSS].object!
        return this[Strings.parseDeclarationList].function!(this: this, arguments: [css.jsValue(), options?.jsValue() ?? .undefined]).fromJSValue()!
    }

    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    @inlinable public static func parseDeclarationList(css: CSSStringSource, options: CSSParserOptions? = nil) async throws -> [CSSParserRule] {
        let this = JSObject.global[Strings.CSS].object!
